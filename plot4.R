...
par(mfrow=c(2,2))
#plot 1
plot(dfEPC$DateTime,dfEPC$Global_active_power,type="l",xlab="",ylab="Global Active Power")
#plot 2
plot(dfEPC$DateTime,dfEPC$Voltage,type="l",xlab="datetime",ylab="Voltage")
#plot 3
...
#plot 2 again
plot(dfEPC$DateTime,dfEPC$Global_reactive_power,type="l",
